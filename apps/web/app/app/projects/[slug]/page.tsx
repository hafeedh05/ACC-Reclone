  ...
  if (!project) {
    return (
      <AetherAppShell
        ...
        subtitle="Workspace data is temporarily unavailable."
      >
        <section className="aether-project-shell">
          <div className="aether-panel aether-panel--alert">
            <p className="aether-kicker">Workspace unavailable</p>
            <h2>We could not load this project.</h2>
            <p>The API did not respond. Confirm the backend is running, then refresh this page.</p>
            <Link href="/app/projects" className="aether-btn aether-btn--secondary">
              Back to projects
            </Link>
          </div>
        </section>
                  ...
                  <form action={createRunAction} className="aether-brief-form">
                    ...
                    <div className="aether-brief-form__grid">
                      ...
                      <label>
                        ...
                        <input name="call_to_action" type="text" placeholder="Optional" />
                      </label>
                    </div>
                    ...
                    <fieldset className="aether-format-select">
                      ...
                      <div className="aether-chip-grid aether-chip-grid--tight">
                        {durationOptions.map((duration) => (
                          <label key={duration} className="aether-chip-select">
                            <input
                              type="radio"
                              name="duration_seconds"
                              value={duration}
                              defaultChecked={duration === 8}
                            />
